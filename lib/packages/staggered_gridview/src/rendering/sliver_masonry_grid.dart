...
import 'package:distress_app/packages/staggered_gridview/src/foundation/extensions.dart';
import 'package:distress_app/packages/staggered_gridview/src/rendering/sliver_simple_grid_delegate.dart';
...
class RenderSliverMasonryGrid extends RenderSliverMultiBoxAdaptor {
  ...
  void setupParentData(RenderObject child) {
    if (child.parentData is! SliverMasonryGridParentData) child.parentData = SliverMasonryGridParentData();
  }
