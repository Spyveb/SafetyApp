...
import 'package:distress_app/packages/staggered_gridview/src/layouts/sliver_patterned_grid_delegate.dart';
...
class SliverWovenGridDelegate extends SliverPatternGridDelegate<WovenGridTile> {
  ...
  SliverPatternGridGeometries getGeometries(
    ...
    for (int i = 0; i < count; i++) {
      ...
      final tilePatternIndex =
          i < crossAxisCount ? i % patternCount : (count - 1 - (i % crossAxisCount)) % patternCount;
