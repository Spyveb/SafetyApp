    ...
    return Scaffold(
      ...
      body: GestureDetector(
        ...
        child: GetBuilder<ReportedNonEmgCasesController>(
          ...
          builder: (controller) {
            return controller.reportCaseModel!.nonEmergencyCaseContents != null && controller.reportCaseModel!.nonEmergencyCaseContents!.isNotEmpty
                ? BackgroundWidget(
                    child: Stack(
                      children: [
                        PageView.builder(
                            ...
                            if (controller.reportCaseModel!.nonEmergencyCaseContents![value].docType == 'video') {
                              ...
                              if (controller.videoController != null) {
                                if (controller.videoController!.isInitialised == true) {
                                  if (controller.videoController!.videoUrl != controller.reportCaseModel!.nonEmergencyCaseContents![value].value) {
                                    controller.videoController = PodPlayerController(
                              ...
                              if (controller.reportCaseModel!.nonEmergencyCaseContents![value].value != null) {
                                await controller.setSourceUrl(controller.reportCaseModel!.nonEmergencyCaseContents![value].value!);
                                controller.initAudio();
                              }
                            } else {
                              if (controller.playerState == PlayerState.playing) {
                                            ...
                                            child: Column(
                                              ...
                                              children: [
                                                ...
                                                Row(
                                                  children: [
                                                    Text(
                                                      audioController.position != null ? audioController.position.toString().split('.').first : "0:00:00",
                                                      style: TextStyle(
                                                    ...
                                                    Expanded(
                                                      child: Slider(
                                                        value: audioController.position != null ? audioController.position!.inMilliseconds.toDouble() : 0.0,
