...
class SocialWorkerEditProfileScreen extends GetView<SocialWorkerSettingController> {
  const SocialWorkerEditProfileScreen({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: GetBuilder<SocialWorkerSettingController>(
          builder: (controller) {
            return Column(
